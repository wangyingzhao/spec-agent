...
```java
File: lottery-screen/src/main/java/com/lottery/screen/websocket/DrawWebSocketHandler.java
Line: 88
...
```java
File: lottery-job/src/main/java/com/lottery/job/handler/EmployeeSyncJobHandler.java
Line: 36
...
```java
Files:
- lottery-common/lottery-common-core/src/main/java/com/lottery/common/core/enums/EmployeeType.java:33, 40
- lottery-common/lottery-common-core/src/main/java/com/lottery/common/core/enums/EventStatus.java:38, 45
- lottery-common/lottery-common-core/src/main/java/com/lottery/common/core/enums/PrizeStatus.java:43, 50
- lottery-common/lottery-common-core/src/main/java/com/lottery/common/core/enums/DrawMethod.java:38, 45
- lottery-common/lottery-common-core/src/main/java/com/lottery/common/core/enums/PrizeType.java:33, 40
...
**示例** (lottery-core/lottery-core-engine/src/main/java/com/lottery/core/engine/algorithm/impl/WeightedDrawAlgorithm.java):
```java
...
- ✅ 包名: 全小写 (如 `com.lottery.core.engine`)
...
**示例** (lottery-core/lottery-core-engine/src/main/java/com/lottery/core/engine/strategy/impl/RandomDrawStrategy.java):
```java
// ✅ 使用占位符，避免字符串拼接
...
**示例** (lottery-admin/src/main/java/com/lottery/admin/controller/PrizeController.java):
```java
// ✅ 控制器方法简洁清晰
@PostMapping
...
**示例** (lottery-screen/src/main/java/com/lottery/screen/websocket/DrawWebSocketHandler.java):
```java
...
**示例** (lottery-common/lottery-common-core/src/main/java/com/lottery/common/core/result/Result.java):
```java
// ✅ 设计良好的响应包装类
@Data
@NoArgsConstructor
